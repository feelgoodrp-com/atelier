...
/** forwardRef so the context-menu trigger (Radix Slot) can attach to the button. */
export const TattooCard = forwardRef<HTMLButtonElement, TattooCardProps>(
  function TattooCard({ tattoo, selected, onSelect, ...rest }, ref) {
